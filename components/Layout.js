      ...
      <header>
        {home ? (
          <div className='bg-amber-400 h-screen flex flex-col'>
            <Header />
            <div className='grow py-2 lg:py-16'>
              <div className="mx-auto max-w-5xl h-full py-6 px-6 grid grid-cols-1 gap-y-8 items-center md:grid-cols-2 md:gap-x-12 md:gap-y-16">
                ...
                <div className='mt-8 lg:mt-0 relative flex flex-col gap-3'>
                  <h1 className="text-2xl font-normal tracking-tight text-gray-[#39393A] sm:text-4xl">
                    I'm a UI developer with over ten years experience working with businesses to build amazing digital experiences.
                  </h1>
                  <Link href="/posts">
          ...
          <div className="flex flex-col bg-zinc-200/30">
            <Header />
            <main>{children}</main>
            <Footer />
          </div>
